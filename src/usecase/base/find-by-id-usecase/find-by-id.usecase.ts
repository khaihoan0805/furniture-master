...
export interface IFindByIdUsecase<D extends IDomain, I extends IBaseHttpInput, O extends IBaseHttpOutput> {
    execute(input: I): Promise<O>
}

@injectable()
export abstract class FindByIdUsecase<D extends IDomain, I extends IBaseHttpInput & { id: number }, O extends IBaseHttpOutput> extends BaseUsecase<I, O>{
