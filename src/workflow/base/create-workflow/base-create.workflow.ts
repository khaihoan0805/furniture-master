import { BaseWorkflow, IDomain } from "../../../infrastructure/base";
...
export interface ICreateWorkflow<D extends IDomain,I extends ICreateInput, O extends ICreateOutput<D>> {
    execute(input: I): Promise<O>
}

@injectable()
export abstract class CreateWorkflow<D extends IDomain , I extends ICreateInput, O extends ICreateOutput<D>> extends BaseWorkflow<I, O> {
